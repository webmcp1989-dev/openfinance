...
3. Confirm Acme shows nine open POs plus the two historical disputed invoices and their open exceptions.
...
3. Confirm it reports nine open POs, one seeded batch, two disputed submissions, two open exceptions, and one reset audit event.
