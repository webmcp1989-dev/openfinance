    ...
    const tools: WebMcpTool[] = [
      {
        ...
        execute: () => api("/api/agent/requirements"),
      },
      {
        ...
        annotations: { readOnlyHint: true },
        execute: (input) => api("/api/agent/purchase-orders", { method: "POST", body: JSON.stringify(input) }),
      },
      {
        ...
        annotations: { readOnlyHint: true },
        execute: (input) => api("/api/agent/validate", { method: "POST", body: JSON.stringify(input) }),
      },
      {
        ...
        execute: async (input) => {
          const result = await api("/api/agent/submissions", { method: "POST", body: JSON.stringify(input) });
      ...
      },
      {
        ...
        annotations: { readOnlyHint: true },
        execute: (input) => api("/api/agent/status", { method: "POST", body: JSON.stringify(input) }),
      },
    ];
