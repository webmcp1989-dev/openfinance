...
- `supabase/tests/exception-to-cash.test.sql` verifies exception/inquiry/revision data boundaries, idempotent serialization, PDF evidence integrity, and a complete authorized replacement transition.
