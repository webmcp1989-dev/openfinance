...
- `supabase/tests/submission-wrapper.test.sql` verifies policy alignment, wrapper execution mode, retry serialization, identical-response replay, single balance decrement, changed-payload rejection, and duplicate rejection.
