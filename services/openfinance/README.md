...
- `supabase/tests/delivery-events.test.sql` exercises duplicate rejection, direct-RPC field validation, legal state transitions, identical retry replay, single state mutation, and changed-payload rejection.
